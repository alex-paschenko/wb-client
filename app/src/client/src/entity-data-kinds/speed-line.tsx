// app/src/client/src/entity-data-kinds/speed-line.tsx
...
const DATA_KIND = 'speedLine' as const;
...
const getData = ({
  ...
  return {
    ...
    value: accessor.get(index, 'speed'),
  };
};
...
export const speedLineDataKindHandler:
